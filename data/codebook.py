"""
Mahadevan / indusscript.in Codebook
====================================
Source: indusscript.in → TABLES section (all 7 tabs photographed)
These are the official code mappings for the Firestore fields.
...
# fs80=0 in Firestore = "No field symbol on the side" (FS77 code 0)
...
# ---------------------------------------------------------------------------
# 5. POSNUM (sideline in Firestore = line of text)
# Source: Table 5 "CODE FOR LINES OF TEXT" (Numerical col.9)
# NOTE: In Firestore the field is called `sideline` but maps to line number
# ---------------------------------------------------------------------------
LINES_OF_TEXT = {
    "0": "Only line on side",
    "1": "First line",
...
# Source: Table 6 "DIRECTION OF WRITING" (seen in Firestore: "1", "3")
