...
# Directionality note:
# Indus seals are carved in mirror-image so impressions read right-to-left (RTL).
# Sequences here are stored in LINGUISTIC order (initial morpheme first, terminal last),
# which for RTL seals means the physical right-to-left reading is reversed before storage.
# Direction "RTL" = standard seal; "LTR" = tablet/graffiti/boustrophedon exception.
# All proof functions call linguistic_seq() to normalise before analysis — do not
# access seal["seq"] directly in statistical code.

CORPUS = [
    {"id": "M-1",  "site": "Mohenjo-Daro", "dir": "RTL", "seq": ["P122", "P385"]},
    {"id": "M-2",  "site": "Mohenjo-Daro", "dir": "RTL", "seq": ["P060", "P122", "P385"]},
    {"id": "M-3",  "site": "Mohenjo-Daro", "dir": "RTL", "seq": ["P316", "P122", "P385"]},
    {"id": "M-4",  "site": "Mohenjo-Daro", "dir": "RTL", "seq": ["P062", "P062", "P091", "P122"]},
    {"id": "M-5",  "site": "Mohenjo-Daro", "dir": "RTL", "seq": ["P311", "P060", "P122", "P385"]},
    {"id": "M-6",  "site": "Mohenjo-Daro", "dir": "RTL", "seq": ["P117", "P311", "P385"]},
    {"id": "M-7",  "site": "Mohenjo-Daro", "dir": "RTL", "seq": ["P210", "P122", "P385"]},
    {"id": "M-8",  "site": "Mohenjo-Daro", "dir": "RTL", "seq": ["P352", "P311", "P385"]},
    {"id": "M-9",  "site": "Mohenjo-Daro", "dir": "RTL", "seq": ["P174", "P175", "P385"]},
    {"id": "M-10", "site": "Mohenjo-Daro", "dir": "RTL", "seq": ["P060", "P316", "P122", "P385"]},
    {"id": "M-11", "site": "Mohenjo-Daro", "dir": "RTL", "seq": ["P091", "P060", "P385"]},
    {"id": "M-12", "site": "Mohenjo-Daro", "dir": "RTL", "seq": ["P311", "P122", "P385"]},
    {"id": "M-13", "site": "Mohenjo-Daro", "dir": "RTL", "seq": ["P062", "P316", "P385"]},
    {"id": "M-14", "site": "Mohenjo-Daro", "dir": "RTL", "seq": ["P122", "P060", "P385"]},
    {"id": "M-15", "site": "Mohenjo-Daro", "dir": "RTL", "seq": ["P060", "P311", "P122", "P385"]},
    {"id": "M-16", "site": "Mohenjo-Daro", "dir": "RTL", "seq": ["P316", "P060", "P385"]},
    {"id": "M-17", "site": "Mohenjo-Daro", "dir": "RTL", "seq": ["P091", "P122", "P385"]},
    {"id": "M-18", "site": "Mohenjo-Daro", "dir": "RTL", "seq": ["P311", "P316", "P385"]},
    {"id": "M-19", "site": "Mohenjo-Daro", "dir": "RTL", "seq": ["P060", "P062", "P122", "P385"]},
    {"id": "M-20", "site": "Mohenjo-Daro", "dir": "RTL", "seq": ["P117", "P122", "P385"]},
    {"id": "M-21", "site": "Mohenjo-Daro", "dir": "RTL", "seq": ["P311", "P060", "P316", "P385"]},
    {"id": "M-22", "site": "Mohenjo-Daro", "dir": "RTL", "seq": ["P122", "P311", "P385"]},
    {"id": "M-23", "site": "Mohenjo-Daro", "dir": "RTL", "seq": ["P062", "P122", "P060", "P385"]},
    {"id": "M-24A","site": "Mohenjo-Daro", "dir": "RTL", "seq": ["P062", "P062", "P091", "P122"]},
    {"id": "M-25", "site": "Mohenjo-Daro", "dir": "RTL", "seq": ["P060", "P122", "P311", "P385"]},
    {"id": "H-1",  "site": "Harappa",      "dir": "RTL", "seq": ["P122", "P385"]},
    {"id": "H-2",  "site": "Harappa",      "dir": "RTL", "seq": ["P311", "P122", "P385"]},
    {"id": "H-3",  "site": "Harappa",      "dir": "RTL", "seq": ["P060", "P385"]},
    {"id": "H-4",  "site": "Harappa",      "dir": "RTL", "seq": ["P316", "P122", "P385"]},
    {"id": "H-5",  "site": "Harappa",      "dir": "RTL", "seq": ["P091", "P311", "P385"]},
    {"id": "H-6",  "site": "Harappa",      "dir": "RTL", "seq": ["P062", "P122", "P385"]},
    {"id": "H-7",  "site": "Harappa",      "dir": "RTL", "seq": ["P122", "P060", "P311", "P385"]},
    {"id": "H-8",  "site": "Harappa",      "dir": "RTL", "seq": ["P311", "P060", "P385"]},
    {"id": "H-9",  "site": "Harappa",      "dir": "RTL", "seq": ["P117", "P316", "P385"]},
    {"id": "H-10", "site": "Harappa",      "dir": "RTL", "seq": ["P122", "P311", "P060", "P385"]},
    {"id": "D-1",  "site": "Dholavira",    "dir": "RTL", "seq": ["P311", "P122", "P060", "P385"]},
    {"id": "D-2",  "site": "Dholavira",    "dir": "RTL", "seq": ["P060", "P316", "P122", "P385"]},
    {"id": "D-3",  "site": "Dholavira",    "dir": "RTL", "seq": ["P091", "P062", "P385"]},
    {"id": "D-4",  "site": "Dholavira",    "dir": "RTL", "seq": ["P316", "P311", "P122", "P385"]},
    {"id": "G-1",  "site": "Gulf/Dilmun",  "dir": "RTL", "seq": ["P122", "P316", "P385"]},
    {"id": "G-2",  "site": "Gulf/Dilmun",  "dir": "RTL", "seq": ["P060", "P122", "P316", "P385"]},
]


def linguistic_seq(seal: dict) -> list[str]:
    """
    Return the sign sequence in linguistic order (initial morpheme first, terminal last).

    RTL seals are stored already in linguistic order (physical sequence reversed).
    LTR inscriptions (some tablets, graffiti) must be reversed before analysis so
    that seq[-1] is always the terminal/suffix position across the entire corpus.

    Always use this function in proof code — never index seal["seq"] directly.
    """
    seq = seal["seq"]
    return list(reversed(seq)) if seal.get("dir", "RTL") == "LTR" else seq
...
def proof1_suffix_theorem(target="P385"):
    ...
    terminal  = sum(1 for seq in seqs if seq and seq[-1] == target)
    initial   = sum(1 for seq in seqs if seq and seq[0]  == target)
    total_occ = sum(1 for seq in seqs for sign in seq if sign == target)
    mean_len  = sum(len(seq) for seq in seqs) / len(seqs)
...
def proof2_positional_entropy():
    ...
    for seal in CORPUS:
        for i, sign in enumerate(linguistic_seq(seal)):
...
def proof3_semantic_cluster(cluster=("P316", "P122", "P062")):
    ...
    observed = sum(1 for seq in seqs if all(c in seq for c in cluster))
    expected = n_seals
    for c in cluster:
...
def proof4_agglutination(sign_a="P122", sign_b="P385"):
    ...
    observed = sum(
        ...
        if seq[i] == sign_a and seq[i + 1] == sign_b
    )
