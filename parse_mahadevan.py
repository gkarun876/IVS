"""
NOTE: Pass the raw corpus file as the first argument, or set the default path
below. Output is data/mahadevan_corpus.json (already committed).
This script need only be re-run if the raw corpus file is re-generated.
----------------------------------------------------------------------
...
if __name__ == "__main__":
    inp = sys.argv[1] if len(sys.argv) > 1 else "indusarray_raw.txt"
